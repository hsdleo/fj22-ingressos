...
<ingresso:template>
	<jsp:body>
						...
						<table>
							...
							<c:forEach var="lugar" items="${map.value}">
								<td class="fileira-assento"><figure>
										<svg class="assento" version="1.0" id="SEAT"
		...
		<div class="col-md-6 col-md-offset-3">
			<a href="/admin/lugar?salaId=${sala.id}"
					class="btn btn-block btn-info">Novo</a>
						<a href="/admin/lugares?salaId=${sala.id}"
					class="btn btn-block btn-info">Nova Fileira</a>
